...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~ তোমার চুল ওটে নাই নাকি?? 🤖", threadID);
   };

  if ((event.body.toLowerCase() == "Antor") || (event.body.toLowerCase() == "Antor vai") || (event.body.toLowerCase() == "@Antor ッ") || (event.body.toLowerCase() == "ভাইয়া")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Antor ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 antor.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/md.antor.ahmed.841428\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01568945***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:ANTOR ❤️ হাই আমি মেসেঞ্জার ROBOT আামার বস অন্তর আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Antorッ❤️ তাকে সবাই  অন্তর নামে  চিনে👌", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "ami tor boss") || (event.body.toLowerCase() == "ami antor") || (event.body.toLowerCase() == "cup ami antor") || (event.body.toLowerCase() == "ki hoiche re tor")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস অন্তর এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Hridoy") || (event.body.toLowerCase() == "হৃদয়")) {
     return api.sendMessage("🥰-হৃদয়-🌺 আমার বস অন্তর এর বন্ধু লাগে বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম বলো নাহ্ মাথা অনেক গরম আছে🤬⛏️😷", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ki") || (event.body.toLowerCase() == "okay")) {
     return api.sendMessage("️এতো কি কি করো কেনো..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("হাসলে তোমাকে পরীর মতো লাগে..🌸😌", threadID);
   };

   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে অন্তর এর ইনবক্সে চলে যাও 🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("সব ফাঁকি বাজি 😪🥱", threadID);
   };
